...
import { VPS_MULTIPLAYER_URL } from "./scripts/vps-host.mjs";

// The dev site always offers multiplayer against the VPS server. Vite reads
...
process.env.VITE_MULTIPLAYER_URL = VPS_MULTIPLAYER_URL;
