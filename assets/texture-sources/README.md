...
The current runtime versions are generated by `npm run optimize:textures`: the three ground/concrete originals below are resized to 1024×1024 and encoded at quality 80. Originals remain at 1254×1254. The earlier quality-88 commands are retained below as source history. Tank wear and conifer lossless WebP sources are also preserved here; the optimizer keeps their dimensions and writes WebP runtime copies, with lossless foliage alpha.
