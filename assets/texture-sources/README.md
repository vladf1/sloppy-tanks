...
Created with the built-in image generation tool. Original: `weathered-concrete.webp` (1254 × 1254). Runtime: `public/textures/walls/weathered-concrete.webp`, encoded with `cwebp -q 88 -m 6 -metadata none`. All four perimeter walls share the image, with a four-metre tile size on faces and tops. The saved asset ships directly; neither browser nor CI regenerates it.
...
The current runtime versions are generated by `npm run optimize:textures`. Grass uses 768×768 at quality 75; dirt and concrete use 512×512 at quality 80. Their lossless originals remain at 1254×1254. Quarry sandstone uses 768×768 at quality 75 from the preserved pre-optimization WebP in `quarry/`; no lossless sandstone original was available in the repository. The earlier quality-88 commands below are source history, not current settings. Tank wear and conifer lossless WebP sources are also preserved here; the optimizer keeps their dimensions and writes WebP runtime copies, with lossless foliage alpha.

```sh
cwebp -q 88 -m 6 -metadata none assets/texture-sources/dry-grass.webp -o public/textures/ground/dry-grass.webp
cwebp -q 88 -m 6 -metadata none assets/texture-sources/packed-dirt.webp -o public/textures/ground/packed-dirt.webp
```
